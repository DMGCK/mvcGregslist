...
export class Car{
  ...
  <div class=" col-6 col-md-3">
    <div class="rounded shadow p-2" ">
      ...
      <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#form-modal" onclick="app.carsController.openEditForm('${this.id}')"><i class="mdi mdi-pencil"></i></button>
    </div>
  </div>
    `
  }
